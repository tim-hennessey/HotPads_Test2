...
app.Animation = (function () {
    ...
    function initialize() {
        ...
        TweenMax.set(bubble, {transformOrigin: 'bottom right'});
    ...
    function start() {
        ...
        tl.staggerTo(circle, .5, {opacity: 1, repeat: 3, yoyo: true}, 0.25)
            .from(bubble, .75, {width: 99, ease: Elastic.easeOut.config(.3, .2)})
            .to(txt1, .5, {opacity: 1, x: "-=10", ease: Elastic.easeOut.config(.5, .2)}, "-=.7")
